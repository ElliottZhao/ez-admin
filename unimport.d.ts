export {}
declare global {
  const __buildAssetsURL: typeof import('D:/Workspaces/personal/ez-admin/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('D:/Workspaces/personal/ez-admin/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const defineAppConfig: typeof import('D:/Workspaces/personal/ez-admin/node_modules/nuxt/dist/core/runtime/nitro/config')['defineAppConfig']
  ...
  const defineNitroErrorHandler: typeof import('#internal/nitro')['defineNitroErrorHandler']
  ...
  const defineTask: typeof import('#internal/nitro')['defineTask']
  ...
  const prisma: typeof import('D:/Workspaces/personal/ez-admin/node_modules/@prisma/nuxt/dist/runtime/server/utils/prisma')['default']
  const prismaD: typeof import('D:/Workspaces/personal/ez-admin/node_modules/@prisma/nuxt/dist/runtime/server/utils/prisma.d')['default']
  ...
  const runTask: typeof import('#internal/nitro')['runTask']
  ...
  const useAppConfig: typeof import('#internal/nitro')['useAppConfig']
  const useBase: typeof import('h3')['useBase']
  const useEvent: typeof import('#internal/nitro')['useEvent']
...
declare global {
  // @ts-ignore
  export type { CustomPrismaClient } from 'D:/Workspaces/personal/ez-admin/node_modules/@prisma/nuxt/dist/runtime/server/utils/prisma.d'
  import('D:/Workspaces/personal/ez-admin/node_modules/@prisma/nuxt/dist/runtime/server/utils/prisma.d')
}